...
class MockContext : Context() {
    ...
    override fun getSystemService(name: String): Any? = "this is a test"
...
class ContextTest : StringSpec({
    ...
    "service name should not empty" {
        mockContext.getSystemService("") shouldBe "this is a test"
        mockContext.mainExecutor
    }
})